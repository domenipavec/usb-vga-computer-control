...
CyFxUVCApplnInit (void)
{
    ...
    CyU3PUsbSetDesc (CY_U3P_USB_SET_DEVQUAL_DESCR, 0, (uint8_t *)UsbDescriptorDeviceQualifier);
    CyU3PUsbSetDesc (CY_U3P_USB_SET_SS_BOS_DESCR, 0, (uint8_t *)UsbDescriptorBOS);
