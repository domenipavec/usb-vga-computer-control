 ...
 * the implications!
 */
#define  USB_CFG_DEVICE_ID       0xd9, 0x27 /* = 0x27d9 = this is general HID */
 ...
 */
#define USB_CFG_VENDOR_NAME     'i', 'p', 'a', 'v', 'e', 'c', '.', 'n', 'e', 't'
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'v', 'g', 'a', ' ', 'c', 'o', 'n', 't', 'r', 'o', 'l'
 ...
 */
#define USB_CFG_HID_REPORT_DESCRIPTOR_LENGTH 182
